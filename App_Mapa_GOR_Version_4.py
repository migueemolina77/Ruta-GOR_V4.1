...
def conectar_documento_sheets():
    ...
    try:
        ...
        return cliente.open(nombre_hoja)
...
def diagnosticar_vias_conocidas():
    ...
    try:
        nombre_hoja = st.secrets["google_sheets"]["nombre_hoja"]
        resultado["nombre_hoja_buscado"] = nombre_hoja
    except Exception as e:
        resultado["error"] = f"No se pudo leer st.secrets['google_sheets']['nombre_hoja']: {e}"
        return resultado

    try:
        documento = cliente.open(nombre_hoja)
    except Exception as e:
        resultado["error"] = f"No se pudo abrir el documento '{nombre_hoja}': {e}"
        return resultado
